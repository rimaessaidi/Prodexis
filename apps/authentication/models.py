...
from apps.home.models import project_user  # Add this import
...
class Users(db.Model, UserMixin):
    ...
    role          = db.Column(db.String(64), default='user')  # Add role column
    country       = db.Column(db.String(20), nullable=False, default='International')  # Add country column
